...
import ra.edu.validate.position.UpdateSalaryRangeValid;
...
@Setter
@NoArgsConstructor
@UpdateSalaryRangeValid(message = "Maximum salary must be greater than minimum salary.")
public class UpdatePositionDTO {
    ...
    @Positive(message = "Maximum salary must be greater than minimum salary.")
